...
%>
<h1 style="text-align: center;"><span style="color: #0000ff;"><strong>Welcome Back to the UUber, <%= user_name %>!</strong></span></h1>
<h2 style="text-align: center;"><span style="color: #ff6600;">Please Select Your Option:</span></h2>
<h3 style="text-align: center;">
    1. Make Reservation<br />
    2. Record a Ride<br />
